    ...
    <div className="p-10">
      <div className="m-10">
        ...
        <p className="text-slate-500 font-semibold text-center mt-5 text-lg">
          Created Web App inspired from YouTube, having features of watching
          videos, getting recommendation while watching, like, subscribe,
          comment, and many more.
        </p>

        <div className="flex-col items-center justify-center w-full">
          <div className="h-auto lg:w-[50vw] my-5 flex items-center justify-center">
            <video src="/videoApp.mp4" className="rounded ml-[30vw] max-lg:ml-0" controls />
          </div>
          ...
          <ul className="flex-col justify-center">
            ...
            <li className="">
              <span className="text-slate-500 font-semibold">Firebase :</span>
              <span>
                Used specifically for loading uploaded videos, leveraging its
